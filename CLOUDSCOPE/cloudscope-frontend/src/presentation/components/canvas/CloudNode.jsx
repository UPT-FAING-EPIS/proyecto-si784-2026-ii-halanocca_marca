/**
 * CloudNode – Nodo visual personalizado para ReactFlow.
 * Representa un componente de infraestructura AWS con diseño premium.
 */
...
const CloudNodeComponent = memo(({ data, selected }) => {
  ...
  return (
    <div
      ...
      className="min-w-[140px] rounded-xl border-2 bg-slate-900 overflow-hidden"
    >
      {/* Header del nodo */}
      <div
      ...
      >
        ...
        <div
          ...
          className="w-8 h-8 rounded-lg border flex items-center justify-center font-bold text-[11px] shrink-0 select-none"
        >
          {meta.icon}
        </div>
